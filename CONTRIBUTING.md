...
- Improve plain-English copy.
- Add tested templates or directory entries with official sources.
...
- Include or update tests for every new organisation type, issue prompt, or generated-letter section.
